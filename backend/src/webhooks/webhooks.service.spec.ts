...
describe("WebhooksService", () => {
  ...
  describe("handleGitHubWebhook", () => {
    ...
    it("should process pull_request event without signature verification", async () => {
      ...
      webhookWorkspaceService.findWorkspaceByGitHubRepo.mockResolvedValue(
        "ws-1",
      );
      ...
      expect(
        webhookWorkspaceService.findWorkspaceByGitHubRepo,
  ...
  describe("handleSlackEvent", () => {
    ...
    it("should process message event", async () => {
      ...
      webhookWorkspaceService.findWorkspaceBySlackTeam.mockResolvedValue(
        "ws-1",
      );
      contextItemRepository.findOne.mockResolvedValue(null);
      contextItemRepository.create.mockReturnValue({ id: "item-1" } as any);
      ...
      expect(
        webhookWorkspaceService.findWorkspaceBySlackTeam,
      ).toHaveBeenCalledWith("T12345");
    });
  ...
  describe("handleNotionWebhook", () => {
    it("should process page.updated event", async () => {
      ...
      webhookWorkspaceService.findWorkspaceByNotionWorkspace.mockResolvedValue(
        "ws-1",
      );
      contextItemRepository.findOne.mockResolvedValue(null);
      contextItemRepository.create.mockReturnValue({ id: "item-1" } as any);
      ...
      expect(
        webhookWorkspaceService.findWorkspaceByNotionWorkspace,
      ).toHaveBeenCalledWith("notion-ws-123");
      expect(contextItemRepository.save).toHaveBeenCalled();
